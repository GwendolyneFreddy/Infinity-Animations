/* ========================================================================================= *
 *  v 6.0.0                                                                                  *
 *               W e i D U    G L O W C H E C K    P A T C H    R O U T I N E                *
 *                                                                                           *
 * ========================================================================================= *
 *  This routine prevents Skeletons with modified animations to glow red.                    *
 *  by Turambar ( http://www.shsforums.net/topic/45497-glowing-undead/page-2#entry496098 ).  *
 * ========================================================================================= */
			...
			PATCH_IF NOT ("%rname%" STRING_CONTAINS_REGEXP ~ring[g-n]?9~) BEGIN // immunity ring
				...
				END ELSE BEGIN
					...
					PATCH_IF ("%rname%" STRING_CONTAINS_REGEXP ~ring[g-n]?99~) BEGIN // ring95, contains is true if not contains
						WRITE_ASCII %lring% ~RING95~ #8   // change ring with un-glowing bg2 version
					END ELSE BEGIN
						WRITE_ASCII %lring% ~RINGN99~ #8  // change ring with un-glowing bg1 version
