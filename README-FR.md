...
<table summary="Liste des options d'installation">
	...
	<tr>
		...
		<td><a name="nashkelguards" id="nashkelguards"></a>Le composant Correction des animations des humanoïdes [25] rétablit les slots d'animation adéquats de certaines créatures humanoïdes. À la demande de joueurs nostalgiques qui souhaitent profiter de leur première expérience de BG dans la trilogie ou dans BG:EE, cette option désactive " <em>l'attribution aux gardes amniens l'animation de soldat amnien</em> " pour les gardes de Nashkel.<br><br>
		0 = Non, les gardes de Nashkel conservent leur animation initiale de clerc<br>
		<em>1 = Oui, on attribue aux gardes de Nashkel l'animation de de soldat amnien [par défaut]</em></td>
	</tr>
	<tr>
...
&#9755; <ins>a.Principales mises à jour</ins>
  ...
  - Intégration des correctifs graphiques des animations du BWP Fixpack (merci à leurs auteurs !) :
    ...
    - Archive IA_BGII_IWDII : Correctifs par Gwendolyne de l'<a href="http://www.shsforums.net/topic/55742-fixed-small-elemental-water-bug/">animation de mort du petit élémentaire d'eau d'IWD2</a> et par <a href="https://github.com/GwendolyneFreddy/Infinity-Animations/issues/5.">Sam</a> de <a href="http://www.shsforums.net/topic/44203-ia-bugs-and-fixes/page-4#entry490477">l'animation d'Ellesime aux cheveux blancs qui avait toujours sa chevelure rousse lorsqu'elle attaquait ou lan_ait des sortilèges</a>.
...
- [0] Infinity Animations (t-main.tpa, t-main_ee.tpa)
   - Découpage de cet énorme composant principal en plus petits pour assurer une meilleure lecture et faciliter sa maintenance (*ia_mod_content_check.tpa*, *ia_restore_bg2_animations.tpa*, *ia_replace_low_animations.tpa*, *ia_update_cre_animation_offset.tpa*, *ia_soundsets_conflicts.tpa*, *ia_correct_creature animations.tpa*;*ia_correct_weapon_animations.tpa*). :wink:
    ...
    - <ins>t-animate.tpa</ins> :
        - Correction de la foutue régression introduite par le BWP Fixpack (à partir de la v. 18) qui écrase le fichier animate.ids et corrompt l'installation d'IA en ajoutant des doublons et des slots d'animation valables uniquement pour les jeux EE. :rage:
        - Correction d'un <a href="https://github.com/SpellholdStudios/Infinity-Animations/issues/3">problème d'affichage des animations de Moinesse des femmes humaines</a> : leurs animations d'armes n'étaient pas affichées correctement, à la fois dans leurs mains et sur les paperdolls. Remplacer leurs slot d'animation de la catégorie CHARACTER BGII WQN paletted par la catégorie CHARACTER BGII WQL paletted a résolu le problème. (Merci à eyre-j pour l'avoir signalé)
